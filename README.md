...
- [Compilare automaticamente applicazioni .NET 6 con le pipeline di Azure DevOps e GitHub Action](https://www.dopsitalia.com/script/47/Compilare-Automaticamente-Applicazioni-.NET-Pipeline-Azure-DevOps-GitHub-Action.aspx)
- [Creare un&#39;istanza di Azure Service Bus con ARM](https://www.cloudnativeitalia.com/script/212/Creare-Istanza-Azure-Service-Bus-ARM.aspx)
- [Iniettare servizi in un hosted service di ASP.NET Core](https://www.aspitalia.com/script/1397/Iniettare-Servizi-Hosted-Service-ASP.NET-Core.aspx)
<!-- BLOG-POSTS:END -->
